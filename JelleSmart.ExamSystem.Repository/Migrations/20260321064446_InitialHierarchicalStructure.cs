...
{
    /// <inheritdoc />
    public partial class InitialHierarchicalStructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    UnitId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    GradeId = table.Column<string>(type: "nvarchar(36)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderQuestionsByTopicSequence = table.Column<bool>(type: "bit", nullable: false),
                    GradeId = table.Column<string>(type: "nvarchar(36)", nullable: true),
                    SubjectId = table.Column<string>(type: "nvarchar(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentSubjects_AspNetUsers_StudentUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectCount = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    WrongCount = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    EmptyCount = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentExams_AspNetUsers_StudentUserId",
                        column: x => x.StudentUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAnswers_AspNetUsers_StudentUserId",
                        column: x => x.StudentUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_GradeId_SubjectId",
                table: "Exams",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Topics_UnitId_Order",
                table: "Topics",
                columns: new[] { "UnitId", "Order" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Units_GradeId_Order",
                table: "Units",
