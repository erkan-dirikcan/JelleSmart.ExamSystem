...
namespace JelleSmart.ExamSystem.WebUI.Areas.Student.Controllers
{
    [Area("Student")]
    ...
    public class ExamController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Mevcut öğrenci sınavlarını getir
            var userId = User.FindFirstValue(ClaimTypes.NameIdentifier);
            var studentExams = new List<StudentExam>();
            foreach (var exam in activeExams)
            {
                var se = await _studentExamService.GetByStudentAndExamAsync(userId!, exam.Id);
                if (se != null)
                {
                    studentExams.Add(se);
                }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            // Öğrenci bu sınava daha önce girdi mi?
        ...
        public async Task<IActionResult> Result(int id)
        {
            ...
            var viewModel = new ExamResultViewModel
            {
                ...
                Answers = studentExamWithAnswers.StudentAnswers.Select(sa => new AnswerDetailViewModel
                {
                    ...
                    SelectedChoice = sa.Choice?.Text ?? "Boş",
